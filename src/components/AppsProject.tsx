        ...
        <section className="p-10">
            <div className="flex flex-row-reverse gap-8 items-center justify-between rounded-xl max-w-screen  px-10 bg-explore shadow-md shadow-gray-800">
                <div className="text-end">
                    <p className="py-2 text-3xl leading-8 font-extrabold tracking-tight text-white sm:text-4xl">
                        Explore Our Services
                    </p>
                    <p className="text-sm font-medium">Lorem ipsum sit dolor amet.</p>
                </div>
                <div className="grid grid-cols-3 gap-4 items-center py-10">
                    {featuredProjects.map((project: Project, index: number) => (
                        <div key={index} className="card bg-black w-96 shadow-xl hover:bg-custom-radial-gradient">
